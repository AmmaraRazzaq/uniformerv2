...
MODEL_PATH = '/home/ammara/uniformerv2/UniFormerV2/pretrained_models'
_MODELS = {
    "ViT-B/16": os.path.join(MODEL_PATH, "k400_uniformerv2_b16_8x224.pyth"),
...
def uniformerv2_b16(
    pretrained=False, use_checkpoint=False, checkpoint_num=[0],
    ...
    # model's pretrained argument shouldn't be true here, setting it to False for now.
    if pretrained:
